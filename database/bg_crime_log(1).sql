...
--
-- Host: localhost
-- Generation Time: Sep 06, 2022 at 02:23 PM
...
--
-- Table structure for table `tbladvice`
--

CREATE TABLE IF NOT EXISTS `tbladvice` (
...
--
-- Dumping data for table `tbladvice`
--

INSERT INTO `tbladvice` (`adviceID`, `title`, `advice`, `dateadded`, `status`) VALUES
(1, 'Warning', 'Be careful while operating around Tutii           ', '2022-09-04', 0),
(2, 'Warning', 'Avoid Tongaren at night        ', '2022-09-04', 1);
...
(1, 1, 1, 'reporting', 1, 1, 1, '2022-07-06', '04:04:00', '2022-07-15', '2022-07-15', 0),
(3, 2, 1, ' driver give bribe', 1, 4, 4, '2022-07-28', '18:47:00', '2022-07-28', '2022-07-28', 1),
(4, 1, 1, ' Class 8 girl', 1, 4, 4, '2022-07-28', '16:06:00', '2022-07-29', '2022-07-29', 1),
(5, 3, 1, ' Stolen chicken', 1, 2, 1, '2022-08-31', '14:50:00', '2022-09-01', '2022-09-01', 1),
(6, 2, 4, ' Corruption', 1, 4, 4, '2022-09-01', '14:00:00', '2022-09-02', '2022-09-02', 1),
(7, 2, 4, ' bribe', 1, 2, 1, '2022-09-02', '10:25:00', '2022-09-01', '2022-09-02', 1),
(8, 1, 4, ' rape', 1, 4, 4, '2022-08-30', '14:54:00', '2022-09-02', '2022-09-02', 1),
(9, 1, 4, ' rape boy', 1, 4, 4, '2022-08-29', '09:20:00', '2022-09-02', '2022-09-02', 1);
...
(1, 'Dan', 'kirwa', '0789652341', 'kirwa@gmail.com', 'MALE', 12854698, 1, 1, '2022-07-15', '2022-07-15', 0),
(2, 'Caleb', 'Nyamwesa', '0741258963', 'caleb@gmail.com', 'MALE', 963258, 3, 2, '2022-09-02', '2022-09-02', 1);
...
(4, '852369', 'Alice', 'Namaswa', 'FEMALE', '0785236541', 'alice@gmail.com', 1, 4, 4, 'Ndenge', '0', '2022-09-02', '2022-09-02', 0);
...
(7, 3, 'Lilian', 'Mwenda', 'FEMALE', 35, 'young lady         \r\n       ', 1, 2, 2, '2022-09-02', '2022-09-02', 1);
...
('alice@gmail.com', '28202421', 'user'),
('caleb@gmail.com', '963258', 'admin'),
...
(5, 4, 'alice', 'Namaswa', 'FEMALE', 9865236, '0741258963', 'Was at around noon     \r\n        ', 1, 2, 1, '2022-09-01', 1);
